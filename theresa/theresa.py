...
def map3d(fit, system):
    ...
    if cfg.threed.rtfunc == 'transit':
        ...
        # 5 filters, sinusoidal, cf fit, 5x10 (5filt-fitcf02)
        #params = np.array([-1.2396e+00,  9.0946e-02, -1.3141e-02, 2.4258e+01,
        #                   -2.9274e+00,  1.1148e-02,  1.6406e-01, 1.1100e+01,
        #                   -1.2241e+00,  7.6008e-02, -1.9921e-02, 1.2430e+01,
        #                   -1.9777e+00, -1.9960e-01, -2.5691e-02, 1.0095e+01,
        #                   -2.8279e+00, -1.2376e-01,  2.0942e-01, 1.2406e+01,
        #                   2468.9])
        # 5 filters, sinusoidal, cf fit, 8x16 (5filt-fitcf03)
        #params = np.array([-1.2292e+00,  7.9478e-02, -7.5626e-03, 2.4258e+01,
        #                   -2.9231e+00,  5.0527e-02,  1.6174e-01, 1.1100e+01,
        #                   -1.2189e+00,  6.9590e-02, -1.7182e-02, 1.2430e+01,
        #                   -1.9639e+00, -2.2110e-01, -7.2123e-03, 1.0095e+01,
        #                   -2.8600e+00, -9.9590e-02,  1.5652e-01, 1.2406e+01,
        #                   2460.0])
        # 5 filters, sinusoidal, cf fit symmetric, 5x10 (5filt-fitcf04)
        params = np.array([-8.6658e-01,  4.7763e-02, -2.4342e-01, 2.4258e+01,
                           -3.0127e+00,  3.5182e-01, -5.9738e-01, 1.1100e+01,
                           -8.2379e-01, -6.8388e-02, -3.8924e-01, 1.2430e+01,
                           -1.5912e+00,  4.0940e-02,  1.0636e-01, 1.0095e+01,
                           -3.5981e+00,  1.3231e-01,  2.4316e-01, 1.2406e+01,
                           1204.0]) 
        pstep[3::4] = 0.0
